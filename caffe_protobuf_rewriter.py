...
if __name__=="__main__":
    print("This implementation is buggy and should not be used")
    assert(0)
    if 0:
        ...
        with open("json.output") as fd:
            with open("mylenet.json.output",'w') as f2d:
                ...
                assert(json_dict['layer'][0]['name']=="mnist")
                json_dict['layer'][0]['dataParam']['batchSize']=1
                ...
                #json_dict['layer'][3]['poolingParam']['kernelSize']=1
                #json_dict['layer'][3]['poolingParam']['stride']=1
